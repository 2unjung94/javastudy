...
public class MainClass {
  public static void main(String[] args) {
     ...
     *    
     * 잘못된 값을 전달하면 NumberFormatExeception 예외를 반환한다.
     *  ex) Integer.parseInt("백만원")
     */
   ...
   /* String s3 = "십";
    int n4 = Integer.parseInt(s3); // 오류 발생
    System.out.println(n4);        // NumberFormatExeception 예외를 반환한다*/
