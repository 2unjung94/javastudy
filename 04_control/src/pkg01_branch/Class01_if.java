...
public class Class01_if {
  ...
  public static void method2_elseif() {

    /*
     * else if
     * 1. if 이후에 추가 가능한 선택 구문이다.
     * 2. if 로 처리하지 못한 대상들에게 새로운 조건식을 지정할 수 있다.
    ...
    } else if(/*age>=8 이건 이미 처음 if에서 거른거*/ age<=13) {
  ...
  public static void method3_else() {
