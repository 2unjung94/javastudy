...
public class MainClass {
  ...
  public static void main(String[] args) {
    ...
    // Circle
    // 업캐스팅(upcasting) : 자식 객체는 부모 타입으로 자동 변환된다.
    ...
    System.out.println("shape1 넓이 : " + shape1.getArea());
    System.out.println("shape1 둘레 : " + shape1.getCircum());
    // Rectangle
    ...
    System.out.println("shape2 넓이 : " + shape2.getArea());
    System.out.println("shape2 둘레 : " + shape2.getCircum());
  }
