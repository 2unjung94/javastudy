...
public class MainClass {
  ...
  public static void method2() {
    ...
    // Stream 을 이용하여 만원이 넘는 책의 이름 출력
    books.stream()
      .filter((book) -> book.getPrice() >= 10000)
      .forEach((book) -> System.out.println(book.getTitle()));
    
    // Stream 을 이용하여 2만원이 넘는 책을 List<Book>으로 모은다
  ...
  public static void method4() {
    ...
    List<Book> saleList = books.stream()
                            ...
                            .toList();
    saleList.stream().forEach((book) -> System.out.println(book.getTitle() + " : " + book.getPrice()));
  }
